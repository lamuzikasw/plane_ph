...
export const PATCH_1_2 = {
  ...
  features: [
    ...
    },
    {
      ...
      label: "Точное планирование",
      title: "Дедлайны сохраняют выбранное время",
      description:
        "Plane сохраняет не только дату, но и выбранное вручную время дедлайна при создании и редактировании задачи.",
      highlights: [
        "Ручное время дедлайна больше не превращается в 00:00",
        "Время сохраняется при создании и быстром редактировании",
        "Задачу можно переносить в Done без исполнителя, дедлайна и приоритета",
        "Одинаковое поведение в интерфейсе и через API",
      ],
      icon: "quality",
      action: { label: "Перейти к проектам", href: "/projects/" },
      technicalDetails: {
        title: "Точная нормализация дат",
        description:
          "Клиент и API передают дедлайн с точным временем, а сервер нормализует дату без потери выбранных часов и минут.",
        tools: ["React", "Django serializers", "API", "datetime normalization"],
      },
    },
    {
      id: "og-management",
