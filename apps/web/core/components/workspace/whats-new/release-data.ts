...
export const PATCH_1_1 = {
  ...
  features: [
    ...
    },
    {
      ...
      description: "Основные экраны открываются быстрее, а повторный вход требует меньше ожидания.",
      highlights: [
        "Рабочее пространство появляется на экране быстрее",
        "Повторное открытие страницы требует меньше времени",
        "Во время ожидания сразу видно, что приложение продолжает загружаться",
      ],
      icon: "performance",
