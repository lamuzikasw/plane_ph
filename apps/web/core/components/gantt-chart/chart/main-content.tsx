        ...
        {(helpers) => (
          <>
            <div
              ...
              id="gantt-container"
              className={cn(
                "payholder-timeline-canvas vertical-scrollbar horizontal-scrollbar flex scrollbar-lg h-full w-full overflow-auto border-t-[0.5px] border-subtle",
                {
                  "mb-8": bottomSpacing,
                }
              )}
