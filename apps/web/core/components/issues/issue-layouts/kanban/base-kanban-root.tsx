  ...
  return (
    <>
      ...
      <IssueLayoutHOC layout={EIssueLayoutTypes.KANBAN}>
        <div
          className={`payholder-kanban-board horizontal-scrollbar relative flex scrollbar-lg h-full w-full bg-surface-2 ${sub_group_by ? "vertical-scrollbar overflow-y-auto" : "overflow-x-auto overflow-y-hidden"}`}
          ref={scrollableContainerRef}
        >
          <div className="payholder-kanban-canvas relative h-full w-max min-w-full bg-surface-2">
